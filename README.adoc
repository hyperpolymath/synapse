...
:experimental:
:url-github: https://github.com/hyperpolymath/synapse
:url-gitlab: https://gitlab.com/hyperpolymath/synapse
:url-bitbucket: https://bitbucket.org/hyperpolymath/synapse
:url-codeberg: https://codeberg.org/hyperpolymath/synapse

Neural connection simulation framework
...
synapse is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
